...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~iUwlnYrD#HTnwONv5H_TRuHce1IuM1uoHUfUKK8bKM9koUQNQZ1E",
    CAPTION: process.env.CAPTION || "POWERED BY NIHALTRICKER432",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M DARK-SILENCE-MD NIHAL TRICKER WHATSAPP BOT 😊♻️",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923135887879",
    OWNER_NAME: process.env.OWNER_NAME || "➺NIHAL TRICKER",
